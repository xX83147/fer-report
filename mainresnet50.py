...
for epoch in range(EPOCHS):
    ...
    if test_acc > best_acc:
        ...
        print("已保存最佳模型到 resnet50_best_model.pth")
    else:
        no_improve += 1
...
csv_path = RESULTS_DIR / "resnet50_history.csv"
...
fig_path = FIGURES_DIR / "resnet50_acc_curve.png"
